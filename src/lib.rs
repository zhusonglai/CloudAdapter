...
#[derive(Debug)]
pub struct CloudAdapterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CloudAdapterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CloudAdapter processing");
    
    let mut processor = CloudAdapterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CloudAdapterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CloudAdapterProcessor::new(false);
